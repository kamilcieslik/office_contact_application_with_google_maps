...
public class ModifyContactController implements Initializable {
    ...
    private ViewExtendedContact modifiedContact;
    @FXML
    ...
    public void setFrameObjects(OfficeService officeService, ViewExtendedContact modifiecContact) {
        this.officeService = officeService;
        this.modifiedContact = modifiecContact;
    }
